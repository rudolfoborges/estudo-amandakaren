...
function chegarNoAeroporto(nacionalidade, esteveNoBrasilNosUltimosAnos, naoENazista){
    ...
    else if (nacionalidade === 'alemao' && naoENazista === false) {
        console.log('pode entrar')
    }
    else if (naoENazista === true){
        console.log('não pode entrar')
    }
    else if (nacionalidade === 'ingles'&& esteveNoBrasilNosUltimosAnos === false){
        console.log('pode entrar')
    }
    else if (nacionalidade === 'ingles'&& esteveNoBrasilNosUltimosAnos === true){
        console.log('não pode entrar')
    }
    else {
        console.log('não pode entrar')
